...
g_crew_routines = {
    example_crewmember = {
        routine('08:00', 'Duty Station'),
        routine('19:00', 'Mess Hall'),
        routine('22:00', 'Bed'),
    }
}
...
g_ships = {
    ...
    Example = function() return {
        ...
        location = function() return g_savedata.valid_ships.Example end,
        available_tasks = {
            ['example task'] = function() return {
                name = 'an example of a task',
                priority = 3,
                required_crew = {'Example Crewmember'},

                task_components = {
                    make_task_component('assign_crew'),
                    make_task_component('create_popup', 'This is an example task component!'),
